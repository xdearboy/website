  ...
  return (
    ...
    >
      <div className="relative w-full max-w-[460px] flex flex-col gap-[15px] p-[30px_15px] rounded-[8px] border border-[#9BA3D6] bg-[rgba(255,255,255,0.50)] shadow-[0px_0px_26px_0px_rgba(0,0,0,0.30)]">
        <h2 className="text-center font-mono font-bold text-[20px] text-black">
          donate me :3
        </h2>
          ...
          {cryptoAddresses.map((crypto) => (
            ...
            >
              <div className="flex flex-col gap-[5px]">
                ...
                <p className="text-[14px] break-all opacity-80">
                  {crypto.value}
                </p>
              </div>
            </div>
        ...
        >
          <span className="text-[14px] leading-none whitespace-nowrap text-black">
            copied to clipboard
          </span>
        </div>
      </div>
